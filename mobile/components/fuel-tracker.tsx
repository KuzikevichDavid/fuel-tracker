    ...
    <View className="min-h-screen min-h-[100dvh] flex flex-col p-4 pb-8 max-w-lg mx-auto">
      ...
      <View className="text-center py-6">
        {/* <View className="flex items-center justify-center gap-3 mb-2">
          ...
          <Text className="font-display text-2xl font-bold text-foreground tracking-wider">
            FUEL TRACKER
          </Text>
        </View> */}
        <Text className="text-muted-foreground text-sm">Track your fuel consumption in real-time</Text>
      </View>

      {/* Consumption Rate Input */}
      <View className="dashboard-card p-5 mb-4">
        <Text className="block text-muted-foreground text-sm mb-2 font-medium">
      ...
      <View className="dashboard-card p-6 mb-4 flex-1 flex flex-col justify-center">
        ...
        <View className="text-center mb-8">
          ...
          <Text className="digit-display text-6xl font-bold text-primary">
            {fuelSpent.toFixed(2)}
          </Text>
          <Text className="text-muted-foreground text-lg">liters</Text>
        </View>
        ...
        <View className="text-center mb-6">
          ...
          <Text className="digit-display text-4xl font-semibold text-success">
            {distance.toFixed(2)}
          </Text>
        ...
        {currentPosition && (
          <View className="mt-4 text-center">
            <View className="flex items-center justify-center gap-1 text-muted-foreground text-xs">
